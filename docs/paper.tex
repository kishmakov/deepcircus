...
\newcommand{\CS}{\textcolor{blue}{\mathbf{CS}}}
...
attachment we estimate a complexity score of our function $\CS\left[g \mid \bar{x}, y\right]$.
...
For $n \leqslant 12$ we can compute $\CS\left[g \mid \bar{x}, y\right]$ as the size
