...
// internal-node count of the built tree, a function of (bitness, case_id).
// Pinned so refactors of the tree builder, evaluator, or sampler stay
// deterministic.
constexpr TreeGoldenCase kTreeGoldenCases[] = {
    {17, 42, "01010101010101010", "01010101010101010000000000000000001", 12, 42},
    {24, 188, "110010100111000101010011", "1100101001110001010100111111111111111111111111010", 17, 188},
    {32, 320, "01010101010101010101010101010101",
     "01010101010101010101010101010101000001000000010000000000000000000", 17, 320},
    {48, 480, "110010101100101011001010110010101100101011001010",
     "1100101011001010110010101100101011001010110010101111111111111111111111101101110111011111111111111", 18, 480},
    {64, 640, "0011010100110101001101010011010100110101001101010011010100110101",
     ...
     "00001000000000000000001000000000000000000100000000000000001000000",
     20, 640},
    {100, 1000,
     "0100110011010011001101001100110100110011010011001101001100110100110011010011001101001100110100110011",
     "010011001101001100110100110011010011001101001100110100110011010011001101001100110100110011010011001111111011011111111111111111111111111111111111001111111110111111111111111111011101111111111111111101111",
     21, 1000},
    {128, 1280,
     ...
     "01101001100101100110100110010110011010011001011001101001100101100110100110010110011010011001011001101001"
     "100101100110100110010110111111110011111111111111111111111111111111110111111111111111111111101101111111"
...
TEST(TreeTest, GoldenValues) {
    for (const TreeGoldenCase& c : kTreeGoldenCases) {
        ...
        const gen::TreeCase tree(c.bitness, c.case_id);
