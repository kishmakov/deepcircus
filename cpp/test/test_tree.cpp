...
constexpr TreeGoldenCase kTreeGoldenCases[] = {
    {17, 42, "01010101010101010", "01010101010101010010010100010000010", 9, 42},
    {24, 188, "110010100111000101010011", "1100101001110001010100110000000000010000100001000", 17, 188},
    {32, 320, "01010101010101010101010101010101",
     "01010101010101010101010101010101111110111101010111101111011111111", 18, 320},
    {48, 480, "110010101100101011001010110010101100101011001010",
     "1100101011001010110010101100101011001010110010101111111011111011110111111101111111111011111111110", 20, 480},
    ...
    {128, 1280,
     ...
     "01101001100101100110100110010110011010011001011001101001100101100110100110010110011010011001011001101001"
     "100101100110100110010110"
     "1111111111111111111111111111111011111111111111001111111111111011111111111111111111111111111111111111111"
     "11111101111111111111111110",
     21, 1280},
};

std::string TreeValue(const TreeGoldenCase& c, std::string_view input) {
    return gen::TreeValue(c.bitness, c.case_id, input);
}
...
TEST(TreeTest, GoldenValues) {
    for (const TreeGoldenCase& c : kTreeGoldenCases) {
        ...
        const DecisionTree tree = BuildTreeCase(c.bitness, c.case_id);
