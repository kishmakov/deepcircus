...
namespace {
    ...
    bool IsSmallBitness(uint16_t bitness) { return kMinSmallBitness <= bitness && bitness <= kMaxSmallBitness; }
    ...
    bool IsMediumBitness(uint16_t bitness) { return kMinMediumBitness <= bitness && bitness <= kMaxMediumBitness; }
